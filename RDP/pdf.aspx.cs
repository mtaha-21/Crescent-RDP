...
namespace RDP
{
    ...
    public partial class check1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String myquery1 = "Select * from RRN_details where user_id =" + Request.QueryString["user_id"];
            ...
            da1.Fill(ds1);
                ...
                {
                    nameofsupp.Text = ds1.Tables[0].Rows[0]["Guide_name"].ToString();
                    dept.Text = ds1.Tables[0].Rows[0]["Dept_name"].ToString();
                    topic.Text = ds1.Tables[0].Rows[0]["Research_topic"].ToString();
                    rrn.Text = ds1.Tables[0].Rows[0]["RRN"].ToString();
                }

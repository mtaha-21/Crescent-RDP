               ...
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                              ...
                              <asp:ListItem Text="EEE" Value="3" />
                              <asp:ListItem Text="MECH" Value="4" />
                              <asp:ListItem Text="POLY" Value="5" />
                              <asp:ListItem Text="AERO" Value="6" />
                              <asp:ListItem Text="BCA" Value="7" />
                              <asp:ListItem Text="BSC" Value="8" />
                              <asp:ListItem Text="BCOM" Value="9" />
                              <asp:ListItem Text="BA" Value="10" />
                               </asp:DropDownList>
                        </div>
                         </div>
                        <div class="col-md-4">
                   ...
                   <div class="row">
                            <center>
                                <div class="form-group">
                                <asp:Button Border Style ="margin-top:10px" class="btn btn-success" ID="Button1" runat="server" Text="Generate RRN" Width="200px"/>
                                </div>
                            </center>
                       <div class="row">
                     <div class="col">
                       ...
                       <div class="col-md-6 offset-8">
                         <div class="form-group">
                            <asp:Button Border Style ="margin-top:10px" class="btn btn-primary" ID="Button5" runat="server" Text="Edit" Width="100px" />
                        </div>
                        </div>
                       <div class="col-md-6 offset-8">
                         <div class="form-group">
                            <asp:Button Border Style ="margin-top:10px" class="btn btn-primary" ID="Button4" runat="server" Text="Ok" Width="100px" />
                        </div>
                        </div>
                        <div class="row">
                     <div class="col">

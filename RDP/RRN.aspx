                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                              ...
                              <asp:ListItem Text="CSE" Value="2" />
                              <asp:ListItem Text="ECE" Value="3" />
                              <asp:ListItem Text="EEE" Value="4" />
                              <asp:ListItem Text="MECH" Value="5" />
                              <asp:ListItem Text="POLY" Value="6" />
                              <asp:ListItem Text="AERO" Value="7" />
                              <asp:ListItem Text="BCA" Value="8" />
                              <asp:ListItem Text="BSC" Value="9" />
                              <asp:ListItem Text="BCOM" Value="10" />
                              <asp:ListItem Text="BA" Value="11" />
                               </asp:DropDownList>
                        </div>
                         </div>
                        <div class="col-md-4">

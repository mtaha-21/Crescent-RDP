            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <b>
                                <label>Full Name<span class="required">*</span></label></b>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Enter your full name" required="Required"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <b>
                                <label>Date Of Birth<span class="required">*</span></label></b>
                            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <b>
                                <label>Age<span class="required">*</span></label></b>
                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <form>
                                        <label for="fileUpload">Upload your passport size photo</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <b>
                                <label>Gender<span class="required">*</span></label></b>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <b>
                                <label>Nationality<span class="required">*</span></label></b>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <b>
                                <label>If Foreign, Enter your Country</label></b>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <b>
                                <label>Social Status<span class="required">*</span></label></b>
                            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <b>
                                <label>Marital Status<span class="required">*</span></label></b>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <b>
                                <label>Telephone<span class="required">*</span></label></b>
                            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <b>
                                <label>Mobile Number<span class="required">*</span></label></b>
                            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <b>
                                <label>Email-ID<span class="required">*</span></label></b>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            <b>
                                <label>Residential Address<span class="required">*</span></label></b>
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <b>
                                    <label>Address for Communication<span class="required">*</span></label></b>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <b>
                                    <label>Category<span class="required">*</span></label></b>
                                <div class="form-group">
                                    <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <b>
                                    <label>Type of Registration<span class="required">*</span></label></b>
                                <div class="form-group">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <b>
                                        <label>UG:- <span class="required">*</span></label></b>
                                    <b>
                                        <label>University/College</label></b>
                                    <div class="form-group">
                                    ...
                                    <b>
                                        <label>Month of Passing</label></b>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <b>
                                        <label>PG:- <span class="required">*</span></label></b>
                                    <b>
                                        <label>University/College</label></b>
                                    <div class="form-group">
                                    ...
                                    <b>
                                        <label>Part time / Full time</label></b>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <b>
                                        <label>Master of Philosophy:- </label>
                                    </b>
                                    <b>
                                        <label>University/College</label></b>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <b>
                                        <label>Other Qualifications:-</label></b>
                                    <b>
                                        <label>University/College</label></b>
                                    <div class="form-group">
                                ...
                                <div class="row">
                                    <b>
                                        <label>Bachelor Degree:-</label></b>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <b>
                                                <label>Discipline</label></b>
                                ...
                                <div class="row">
                                    <b>
                                        <label>Professional Experience:-</label></b>
                                    <div class="col-md-8">
                                        <b>
                                            <label>Specify</label></b>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <b>
                                            <label>Name of the Organization you have worked for</label></b>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <b>
                                            <label>Number of years Worked</label></b>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <b>
                                        <label>Enter the fields below,if you have worked in more than one Organization:-</label></b>
                                    <div class="col-md-8">
                                        <b>
                                            <label>Specify</label></b>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <b>
                                            <label>Name and Address of the Employer</label></b>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <b>
                                            <label>Mode of Employment</label></b>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <b>
                                            <label>Working Since Date</label></b>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <b>
                                            <label>Total Years of Experience</label></b>
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="col-md-4">
                                                        <div class="btn btn-primary">
                                                            <asp:FileUpload type="file" ID="imageBrowes" runat="server" required="required" onchange="ShowPreview(this)" />
                                                        </div>
                                                    </div>
                                                </div>
